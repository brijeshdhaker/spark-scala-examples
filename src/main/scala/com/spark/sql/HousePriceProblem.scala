...
object HousePriceProblem {
  ...
  /*  Create a Spark program to read the house data from in/RealEstate.csv,
        ...
        2. Location: city/town where the house is located. Most locations are in San Luis Obispo 
        county and
        ...
        8. Status: type of sale. Thee types are represented in the dataset: Short Sale, Foreclosure 
        and Regular.
  ...
  def main(args: Array[String]) {
    ...
    realEstate.persist(StorageLevel.DISK_ONLY)
    realEstate.unpersist(blocking = true)
