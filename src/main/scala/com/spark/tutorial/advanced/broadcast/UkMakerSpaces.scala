package com.spark.tutorial.advanced.broadcast

import com.spark.tutorial.commons.Utils
...
object UkMakerSpaces {
  ...
  def main(args: Array[String]) {
    ...
    val makerSpaceRdd = sparkContext.
      textFile("in/uk-makerspaces-identifiable-data.csv")
    ...
    val regions = makerSpaceRdd
      ...
      .map(line => postCodeMap.value.getOrElse(getPostPrefix(line).get,
        "Unknown"))
