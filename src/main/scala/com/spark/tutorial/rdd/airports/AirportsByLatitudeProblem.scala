package com.spark.tutorial.rdd.airports
...
/**
 ...
 --class com.spark.tutorial.rdd.airports.AirportsByLatitudeProblem target\spark-training-1.0.jar

 docker exec spark-master /usr/local/spark/bin/spark-submit \
    --master spark://spark-master:7077 \
    --deploy-mode cluster \
    --class com.spark.tutorial.rdd.airports.AirportsByLatitudeProblem \
